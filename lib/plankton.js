...
function sortPostsByTimestamp(posts) {
    posts.sort(function(post1, post2) {
       return post1[constants.TIMESTAMP_GENERATED_PROPERTY] - post2[constants.TIMESTAMP_GENERATED_PROPERTY];
    });
}
...
Plankton.prototype.parsePost = function(text) {
    ...
    if(post.hasOwnProperty(constants.DATE_PROPERTY)) {
        post[constants.TIMESTAMP_GENERATED_PROPERTY] = moment(post.date).valueOf();
    } else {
